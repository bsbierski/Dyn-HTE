...
p = Plots.heatmap(kx,ky,struc,clims=(0.1,0.8))
#= ,clims=(0,1.) =#
...
hm=CairoMakie.heatmap!(ax,[k for k in 1:Nk+1],w_vec, JSkw_mat_total,colormap=:viridis,colorrange=(0.001,1.2),highclip=:white);
