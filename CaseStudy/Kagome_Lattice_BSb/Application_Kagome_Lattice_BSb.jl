...
fileName_c = "CaseStudy/Kagome_Lattice_BSb/Kagome_Lattice_c_iipDyn_nmax"*string(nmax)*"_L"*string(L)*".jld2"
...
if true ### BZ Gk plot
    ...
    display(fig)
    save("CaseStudy/Kagome_Lattice_BSb/Kagome_EqualTimeGk_pade"*string(pade_order)*"_f$f"*"_x$x.png",fig)
end
...
if false
    ...
    display(plt_final)
    savefig(plt_final,"CaseStudy/Kagome_Lattice_BSb/Kagome_moments_x-series_k"*k_label*".png")
end
...
if true
    ...
    display(plt_final)
    savefig(plt_final,"CaseStudy/Kagome_Lattice_BSb/Kagome_moments_u-series_k"*k_label*".png")
end
...
for x0_pos in eachindex(x0_vec)
    ...
    ### plot Sherman's NLCE
    fileNameNCLE = "CaseStudy/Kagome_Lattice_BSb/Sherman2018NLCE_data/Sherman_NLCE_JS_x"*string(x0)*"_"*k_label*".csv"
